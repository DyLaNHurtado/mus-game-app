<template>
    <div class="player-slot" >
      <div v-if="player" class="player-info flex flex-col items-center space-y-4">
        ...
        <p class="player-name text-center flex items-center justify-center space-x-3">
          <svg v-if="isLeader" class="icon w-8 h-8 text-yellow-500 flex items-center justify-center" fill="#eab308" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            <path d="M12.99 23.5C12.99 21.8431 14.3331 20.5 15.99 20.5C17.6468 20.5 18.99 21.8431 18.99 23.5C18.99 25.1569 17.6468 26.5 15.99 26.5C14.3331 26.5 12.99 25.1569 12.99 23.5Z" />
            <path d="M7.5 23.5C7.5 22.3954 8.39544 21.5 9.5 21.5C10.6046 21.5 11.5 22.3954 11.5 23.5C11.5 24.6045 10.6046 25.5 9.5 25.5C8.39542 25.5 7.5 24.6045 7.5 23.5Z"/>
            <path d="M22.4999 21.5C21.3953 21.5 20.4999 22.3954 20.4999 23.5C20.4999 24.6045 21.3953 25.5 22.4999 25.5C23.6044 25.5 24.4999 24.6045 24.4999 23.5C24.4999 22.3954 23.6044 21.5 22.4999 21.5Z"/>
  ...
  <style scoped>
  .player-slot {
    @apply p-4 rounded-lg w-full flex flex-col items-center justify-center bg-gray-800 border border-gray-700 hover:bg-slate-800 transition-all duration-300;
    width: 100%;
    min-height: 200px;
  }
  ...
  .player-name {
    @apply text-xl font-semibold text-white flex items-center space-x-3;
  }
