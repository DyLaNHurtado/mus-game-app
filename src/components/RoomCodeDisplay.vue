<template>
    <div class="text-center mb-6">
      <h2 class="text-2xl font-bold flex justify-center items-center text-nowrap min-h-16">
        Código de Sala: &nbsp; <span class="text-yellow-400">{{ code }}</span> &nbsp;
        <button v-if="!copied" @click="$emit('copy')" class="btn-icon">
          <svg class="w-8 h-8 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <svg v-else class="w-8 h-8 m-3 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
